...
styled.p(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  margin-left: 2px;\n  margin-right: 2px;\n"])));
...
var DatePickerComponent = function DatePickerComponent(_ref) {
  var handleChange = _ref.handleChange,
    ...
    inputWidth = _ref$inputWidth === void 0 ? 120 : _ref$inputWidth,
    _ref$containerWidth = _ref.containerWidth,
    containerWidth = _ref$containerWidth === void 0 ? 320 : _ref$containerWidth,
    _ref$containerHeight = _ref.containerHeight,
    containerHeight = _ref$containerHeight === void 0 ? 42 : _ref$containerHeight,
    ...
    _ref$timePicker = _ref.timePicker,
    timePicker = _ref$timePicker === void 0 ? false : _ref$timePicker,
    _ref$dateType = _ref.dateType,
    dateType = _ref$dateType === void 0 ? 'date' : _ref$dateType,
    _ref$padding = _ref.padding,
    padding = _ref$padding === void 0 ? 10 : _ref$padding,
    _ref$margin = _ref.margin,
    margin = _ref$margin === void 0 ? 2 : _ref$margin;
  var datePickerRef = useRef(null);
  var _useState = useState("datepicker-wrapper-".concat(Math.floor(Math.random() * 10000))),
    _useState2 = _slicedToArray(_useState, 1),
    wrapperId = _useState2[0];
  var _useState3 = useState("datepicker-input-".concat(Math.floor(Math.random() * 10000))),
    _useState4 = _slicedToArray(_useState3, 1),
    inputId = _useState4[0];
  useLayoutEffect(function () {
    var datePicker = new DatePicker("#".concat(wrapperId), {
      date: date,
      input: {
        element: "#".concat(inputId),
        format: format
      },
    ...
    datePicker.on('change', function () {
      ...
      var formattedDate = moment(newDate).format(format.toUpperCase());
  ...
  return /*#__PURE__*/React.createElement(Container, {
    ...
    onChange: function onChange(e) {
      return handleChange(String(e.target.value));
    },
    style: {
      width: inputWidth,
      fontSize: fontSize,
